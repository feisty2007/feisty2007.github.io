...
![](/Asserts/Images//attachment/album/202310/24/155014kli69j43i021iwwl.jpg)
...
那么：请求头是 12 个字节。那些个 12 字节到底意味着什么呢？如果你在 Wireshark 里看看（亦或者阅读 [RFC-1035](https://Asserts/Images/tracker.ietf.org/doc/html/rfc1035#section-4.1.1)），你就能理解：它是由 6 个 2 字节大小的数字串联在一起组成的。
...
如果你想阅读更多有关 DNS 域名压缩之类的内容。我找到了相关更容易让你理解这方面内容的文章： [关于 DNS RFC 的释义](https://Asserts/Images/tracker.ietf.org/doc/html/rfc1035#section-4.1.4)。
