...
date:	2016-12-22 10:29:17 +0800 
categories:	桌面应用 linuxcn 
tags:	[linuxcn,Android,adb,备份]
---


![](/Asserts/Images//attachment/album/201612/22/102743n9ftfojjj3itc92m.jpg)
...
然后， `find` 命令用来搜索数据库。（在我的例子中，我发现数据库在 `/Asserts/Images//Asserts/Images//com.android.providers.telephony/Asserts/Images/bases/mmssms.db`)


建议：如果你的终端输出了太多无关的结果，可以试试使用 `find` 的参数来精简结果。(具体参数可以搜索引擎查下)


![](/Asserts/Images//attachment/album/201612/22/102817u9jt9au1beea9eee.jpg)
...
```
adb push ~/Downloads/mmssms.db /Asserts/Images//Asserts/Images//com.android.providers.telephony/Asserts/Images/bases/mmssms.db
```
