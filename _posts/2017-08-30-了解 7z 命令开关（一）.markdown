...
![](/Asserts/Images/album/201708/19/143244kypyp9rln99qyl9v.png)
...
**注意**：我们将使用以下截图中显示的文件来执行使用 7zip 的各种操作。
 ...
 [![ls from test directory](/Asserts/Images/album/201708/19/143302xyqgjbbptpfwf3pu.png)](https://www.howtoforge.com/images/understanding_7z_command_switches_part_i/big/ls.png) 
...
这是输出：
 ...
 [![add files to 7zip](/Asserts/Images/album/201708/19/143304tyy5g74w77ypm5ah.png)](https://www.howtoforge.com/images/understanding_7z_command_switches_part_i/big/include.png) 
...
这是输出：
 ...
 [![Result](/Asserts/Images/album/201708/19/143305c0gbebnwsrbb0l1k.png)](https://www.howtoforge.com/images/understanding_7z_command_switches_part_i/big/includelist.png) 
...
这是输出：
 ...
 [![exclude files from 7zip](/Asserts/Images/album/201708/19/143306hxsm44cls1vmc1md.png)](https://www.howtoforge.com/images/understanding_7z_command_switches_part_i/big/exclude.png) 
...
这是输出：
 ...
 [![result of file exclusion](/Asserts/Images/album/201708/19/143309famooayyvjs0u1o0.png)](https://www.howtoforge.com/images/understanding_7z_command_switches_part_i/big/excludelist.png) 
...
```
 ...
 [![protect 7zip archive with a password](/Asserts/Images/album/201708/19/143311wspxbbnnpln572pp.png)](https://www.howtoforge.com/images/understanding_7z_command_switches_part_i/big/password.png) 
...
这是输出：
 ...
 [![7zip output directory](/Asserts/Images/album/201708/19/143315xpy5s5mysko8p484.png)](https://www.howtoforge.com/images/understanding_7z_command_switches_part_i/big/output.png) 


在上面的截图中，你可以看到归档文件的所有内容都已经解压了。但是在哪里？要检查文件是否被解压到 ./how/to/forge，我们可以使用 `ls -R` 命令。


 [![result](/Asserts/Images/album/201708/19/143318au8pirl8oz8rte8l.png)](https://www.howtoforge.com/images/understanding_7z_command_switches_part_i/big/ls_-R.png) 
...
这是目录内容的截图：
 ...
 [![7zip volumes](/Asserts/Images/album/201708/19/143319xwdwkof1ks4sk0kd.png)](https://www.howtoforge.com/images/understanding_7z_command_switches_part_i/big/volumels.png) 
...
这是截图：
 ...
 [![compressing volumes](/Asserts/Images/album/201708/19/143322z0cdkdg275zpdezu.png)](https://www.howtoforge.com/images/understanding_7z_command_switches_part_i/big/volume.png) 


现在，要查看创建的子归档，使用 `ls` 命令。


 [![list of archives](/Asserts/Images/album/201708/19/143324hz2um0i3wzbr2sbu.png)](https://www.howtoforge.com/images/understanding_7z_command_switches_part_i/big/volumels2.png) 
...
以下是输出档案（使用 “ls” 命令生成）的列表，其名称表示其创建中使用的压缩级别，输出中的第五列显示压缩级别对其大小的影响。
 ...
 [![7zip compression level](/Asserts/Images/album/201708/19/143326b7l7pzmm1lxx7w0j.png)](https://www.howtoforge.com/images/understanding_7z_command_switches_part_i/big/compression.png) 
...
这是输出：
 ...
 [![](/Asserts/Images/album/201708/19/143328p2gkd0z2vtnok0s2.png)](https://www.howtoforge.com/images/understanding_7z_command_switches_part_i/big/slt.png) 
...
输出的文件是 “howtoforge.zip”。要交叉验证它的类型，使用 `file` 命令：
 ...
 [![](/Asserts/Images/album/201708/19/143329hoq7skkmo1k7o8mn.png)](https://www.howtoforge.com/images/understanding_7z_command_switches_part_i/big/type.png) 
