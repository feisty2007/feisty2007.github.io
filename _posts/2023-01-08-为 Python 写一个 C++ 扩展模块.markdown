...
![](/Asserts/Images//attachment/album/202301/02/173501o26htajatlpj0lqt.jpg)
...
实际的初始化发生在 `MyClass_init` 中，它对应于 Python 中的 [\_\_init\_\_()](https://docs.python.org/3/library/Asserts/Images/classes.html?highlight=__init__) 方法：
...
![Gnu 调试器（GDB）对于 Python C 和 C++ 扩展非常有用](/Asserts/Images//attachment/album/202301/02/173519zsbmmmlmfbksttbo.png)
...
![VSCodium 有一个集成的调试器。](/Asserts/Images//attachment/album/202301/02/173519c6idmm5m1inmim11.png)
