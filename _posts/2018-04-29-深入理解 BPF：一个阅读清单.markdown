...
date:	2018-04-03 12:25:00 +0800 
categories:	技术 linuxcn 
tags:	[linuxcn,跟踪器,BPF,eBPF,过滤器]
---


![](/Asserts/Images//attachment/album/201804/03/122506xddn6s8b8z1m42mm.jpg)
...
对于网络相关的 eBPF 使用案例也有几个教程。有一些值得关注的文档，包括一篇 *eBPF 卸载入门指南*，是关于在 [Open NFP](https://open-nfp.org/Asserts/Images/planes-ebpf/technical-papers/) 平台上用 Netronome 操作的。其它的那些，来自 Jesper 的演讲，[XDP 能为其它人做什么](http://netdevconf.org/2.1/session.html?gospodarek)（及其[第二版](https://www.netdevconf.org/2.2/session.html?gospodarek-xdp-workshop)），可能是 XDP 入门的最好的方法之一。
