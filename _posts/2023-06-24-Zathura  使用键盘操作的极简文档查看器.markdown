...
date:	2023-06-20 09:33:34 +0800 
categories:	分享 linuxcn 
tags:	[linuxcn,PDF,文档查看器]
---


![](/Asserts/Images//attachment/album/202306/20/093244dofs3kcszz7rozsd.jpg)
...
![Zathura 文档查看器界面](/Asserts/Images//attachment/album/202306/20/093335pjaqpbll4v44opo4.png)
...
![Zathura 中的书签](/Asserts/Images//attachment/album/202306/20/093335i5ua85bzuzbczo05.png)


按 `F` 键可以高亮所有链接，每条链接附带一个序号，并且界面底部会显示命令行提示符。在命令行中输入链接对应的序号，按下回车可以用系统默认的浏览器打开该链接。


![高亮及打开文档中的链接](/Asserts/Images//attachment/album/202306/20/093336tlryn0q0i7o55o54.png)
