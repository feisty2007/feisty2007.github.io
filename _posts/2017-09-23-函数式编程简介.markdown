...
layout: post
title:	"函数式编程简介"
date:	2017-09-15 13:53:59 +0800 
categories:	软件开发 linuxcn 
tags:	[linuxcn,函数式编程,Haskell]
---
...
![Introduction to functional programming ](/Asserts/Images//attachment/album/201709/15/135403erbbhprllibyy6lr.png " 函数式编程简介 ")
...
* [Data61 FP 课程](https://github.com/Asserts/Images/61/fp-course) （即 *NICTA* 课程）通过<ruby> 类型驱动开发 <rt>  type-driven development </rt></ruby>来教授基础的抽象概念和数据结构。这是十分困难，但收获也是丰富的，其起源于培训会，如果你有一名愿意引导你函数式编程的程序员，你可以尝试。
