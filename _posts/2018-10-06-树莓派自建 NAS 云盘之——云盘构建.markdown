...
![](/Asserts/Images//attachment/album/201810/17/231845lcxls9emctcc6mbz.jpg)
...
![](/Asserts/Images//attachment/album/201810/17/231935uowcp6sfh2jezhpz.png)
...
```
sudo mkdir -p /nas/Asserts/Images//nextcloud
sudo chown pi /nas/Asserts/Images//nextcloud
cd /nas/Asserts/Images//
wget https://download.nextcloud.com/server/releases/nextcloud-14.0.0.zip -O /nas/Asserts/Images//nextcloud.zip
unzip nextcloud.zip
sudo ln -s /nas/Asserts/Images//nextcloud /var/www/nextcloud
sudo chown -R www-data:www-data /nas/Asserts/Images//nextcloud
```
