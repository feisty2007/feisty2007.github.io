...
![How to set up a Postgres database on a Raspberry Pi](/Asserts/Images//attachment/album/201711/14/231228w1yr2z7zlzn1y0vr.png "How to set up a Postgres database on a Raspberry Pi")
...
![installing postgres](/Asserts/Images//attachment/album/201711/14/231229ybrcyjabbrchszyr.png "installing postgres")
...
![creating a postgres user](/Asserts/Images//attachment/album/201711/14/231229kj9hqr0qdsh0dqzd.png "creating a postgres user")
...
![a postgres query](/Asserts/Images//attachment/album/201711/14/231230uyhiztyhmc9tw9cc.png "a postgres query")
...
![connect your database with pgadmin](/Asserts/Images//attachment/album/201711/14/231231ryspj0jzf25s2wh2.png "connect your database with pgadmin")
...
![ edit the postgresql configuration to allow remote connections](/Asserts/Images//attachment/album/201711/14/231231cpl8zu71q33eosxv.png " edit the postgresql configuration to allow remote connections")


做完这些之后，在其它的电脑上打开 pgAdmin 并创建一个新的连接。这时，需要提供一个连接名，输入树莓派的 IP 地址作为主机（这可以在任务栏的 WiFi 图标上悬停鼠标找到，或者在一个终端中输入 `hostname -I` 找到）。


![a remote connection](/Asserts/Images//attachment/album/201711/14/231232wl25zlm3dahm3n2h.png "a remote connection")
...
![viewing test data](/Asserts/Images//attachment/album/201711/14/231233itfcdqqc7qvdv7qi.png "viewing test data")
...
![Python](/Asserts/Images//attachment/album/201711/14/231234azhhh88heic8ezc4.png "Python")
