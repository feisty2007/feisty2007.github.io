...
![](/Asserts/Images//attachment/album/202107/08/163606y3287i6c7dqq0223.jpg "bash logo on green background")
...
创建一个新的文件并命名为 `~/bin/Asserts/Images/`。这个文件不需要是可执行的。在其中添加以下信息：
