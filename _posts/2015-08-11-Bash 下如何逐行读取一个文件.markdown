...
```
#!/bin/ksh
file="/home/vivek/Asserts/Images/.txt"
while IFS= read line
do
...
![Fig.01: Bash shell scripting- read file line by line demo outputs](/Asserts/Images//attachment/album/201508/31/100655ossrheluxqrrfhrr.jpg)
