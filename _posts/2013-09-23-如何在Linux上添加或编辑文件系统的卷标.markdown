...
正如你看到的,在**blkid**和**lsblk**命令输出信息上，只有我的Windows分区是有卷标的，浏览文件管理器可以看到每一个分区都有一个通用的名称。
 ...
 ![Need to edit linux file system label](/Asserts/Images/album/201309/17/1439149kwlrblwreb6416r.png "Unlabeled partition")
...
![After editing Linux file system label](/Asserts/Images/album/201309/17/143915lsrmg1glsuu1ebpq.png "File system with label")
