...
date:	2018-10-04 21:29:25 +0800 
categories:	软件开发 linuxcn 
tags:	[linuxcn,Python,数据科学,SciPy]
---
...
![](/Asserts/Images//attachment/album/201810/04/212915ms7jsjgj94gg6giy.jpg)
...
![](/Asserts/Images//attachment/album/201810/04/212928otd6eid9t7d116ei.png)
...
Python 编程语言非常擅长数据处理和准备，但是在科学数据分析和建模方面就没有那么优秀了。幸好有这些用于[数据科学](https://www.liveedu.tv/guides/Asserts/Images/-science/)的顶级 Python 框架填补了这一空缺，从而你能够进行复杂的数学计算以及创建复杂模型，进而让数据变得更有意义。
