...
layout: post
title:	"使用深度学习检测疟疾"
date:	2019-05-24 02:00:28 +0800 
categories:	软件开发 linuxcn 
tags:	[linuxcn,AI,深度学习,疟疾]
---
...
![](/Asserts/Images//attachment/album/201905/24/020031gvej75e5rmu5qkz5.png)
...
![Python and TensorFlow](/Asserts/Images//attachment/album/201905/24/020032sbtcaoncgn495557.png "Python and TensorFlow")
...
![疟疾热图](/Asserts/Images//attachment/album/201905/24/020032i8it8lf4q2at5wzn.png "Malaria heat map")
...
![疟原虫检测的血涂片工作流程](/Asserts/Images//attachment/album/201905/24/020033dmm6sm1pp6wskwwm.png "Blood smear workflow for Malaria detection")
...
![A typical CNN architecture](/Asserts/Images//attachment/album/201905/24/020034xybcrznfbfrnlnbk.png "A typical CNN architecture")
...
![Installing dependencies](/Asserts/Images//attachment/album/201905/24/020034txfwzh2g7943l999.png "Installing dependencies")


我使用的是云上的带有一个 GPU 的基于 Debian 的操作系统，这样我能更快的运行我的模型。为了查看目录结构，我们必须使用 `sudo apt install tree` 安装 `tree` 及其依赖（如果我们没有安装的话）。


![Installing the tree dependency](/Asserts/Images//attachment/album/201905/24/020035atuk6kb6z75xbvkk.png "Installing the tree dependency")
...
![Datasets](/Asserts/Images//attachment/album/201905/24/020035m15h5kk31qq3zq3k.png "Datasets")
...
![Malaria cell samples](/Asserts/Images//attachment/album/201905/24/020035vmyssdy5d1p7nadz.png "Malaria cell samples")
...
![Learning curves for basic CNN](/Asserts/Images//attachment/album/201905/24/020036c2li4aa0drahlh44.png "Learning curves for basic CNN")
...
![深度迁移学习的想法](/Asserts/Images//attachment/album/201905/24/020036i4u47qb3rx4444nq.png "Ideas for deep transfer learning")
...
![VGG-19 模型架构](/Asserts/Images//attachment/album/201905/24/020037i9eizi6dia3z2zdj.png "VGG-19 Model Architecture")
...
我们将使用和我们之前的模型相似的配置和回调来训练我们的模型。参考[我的 GitHub 仓库](https://nbviewer.jupyter.org/github/dipanjanS/Asserts/Images/_science_for_all/tree/master/os_malaria_detection/)以获取训练模型的完整代码。我们观察下列图表，以显示模型精确度和损失曲线。


![Learning curves for frozen pre-trained CNN](/Asserts/Images//attachment/album/201905/24/020038jh4u1ux6lqlqblh3.png "Learning curves for frozen pre-trained CNN")
...
![Sample augmented images](/Asserts/Images//attachment/album/201905/24/020039y00h0eg6wxfgx6gn.png "Sample augmented images")
...
![Learning curves for fine-tuned pre-trained CNN](/Asserts/Images//attachment/album/201905/24/020039t5t818u85u41pree.png "Learning curves for fine-tuned pre-trained CNN")
...
![Model accuracy](/Asserts/Images//attachment/album/201905/24/020039pkgzie39gevrdfgy.png "Model accuracy")
...
我鼓励你查看这篇文章中提到的文章和研究论文，没有它们，我就不能形成概念并写出来。如果你对运行和采纳这些技术感兴趣，本篇文章所有的代码都可以在[我的 GitHub 仓库](https://nbviewer.jupyter.org/github/dipanjanS/Asserts/Images/_science_for_all/tree/master/os_malaria_detection/)获得。记得从[官方网站](https://ceb.nlm.nih.gov/repositories/malaria-datasets/)下载数据。
