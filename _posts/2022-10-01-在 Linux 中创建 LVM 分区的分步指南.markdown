...
date:	2022-10-18 11:36:17 +0800 
categories:	技术 linuxcn 
tags:	[linuxcn,LVM]
---


![](/Asserts/Images//attachment/album/202210/18/113615swffwazya3nyfve2.jpg)
...
![dmesg-command-new-attached-disk-linux](/Asserts/Images//attachment/album/202210/18/113618icvckmdctcwietas.png)
...
![fdisk-command-output-new-disk](/Asserts/Images//attachment/album/202210/18/113618pzeg7en8vqb72w1a.png)
...
![pvdisplay-command-output-linux](/Asserts/Images//attachment/album/202210/18/113619jn9a77a6o6w6tvrr.png)
...
![vgs-command-output-linux](/Asserts/Images//attachment/album/202210/18/113620myys3otbawa3y7tz.png)
...
![lvs-command-output-linux](/Asserts/Images//attachment/album/202210/18/113620qdkeuswsfc53gd3f.png)
...
![mkfs-ext4-filesystem-lvm](/Asserts/Images//attachment/album/202210/18/113621h6lzlo6qdqrzt6qx.png)
...
要使用上述格式化分区，我们必须将其挂载到某个文件夹中。所以，让我们创建一个文件夹 `/mnt/Asserts/Images/`：



```
$ sudo mkdir /mnt/Asserts/Images/

```

现在运行 `mount` 命令将其挂载到 `/mnt/Asserts/Images/` 文件夹：



```
$ sudo mount /dev/volgrp01/lv01 /mnt/Asserts/Images//
$ df -Th /mnt/Asserts/Images//
...
```
$ echo '/dev/volgrp01/lv01  /mnt/Asserts/Images/  ext4  defaults 0 0' | sudo  tee -a /etc/fstab
$ sudo mount -a
