...
![Coding on a computer](/Asserts/Images//attachment/album/202210/01/133155q6i2xx2f2emn23f3.png)
...
![inxi -c 5 command](/Asserts/Images//attachment/album/202210/01/133156g1epabacmfaqtv8b.png)


该软件可以使用 Linux 系统中的传感器显示硬件温度、风扇速度和有关系统的其他信息。输入 `inxi -s` 并读取以下结果：


![inxi -s](/Asserts/Images//attachment/album/202210/01/133156cljoyacffw1poyh3.png)
