...
date:	2015-07-14 17:50:00 +0800 
categories:	技术 linuxcn 
tags:	[linuxcn,Ruby,RoR]
---
...
![](/Asserts/Images//attachment/album/201507/14/175043nu5bwu5pdz9pwcbw.png)


如果你在创建数据库时遇到了“Access denied for user 'root'@'localhost' (Using password: NO)”这个错误信息，你需要更新你的config/Asserts/Images/base.yml文件来匹配数据库的**用户名**和**密码**。



```
# 编辑配置文件夹中的 database.yml
nano config/Asserts/Images/base.yml
...
![](/Asserts/Images//attachment/album/201507/14/175019xnnzn3h22toez1a2.png)
